...
public class InventoryUnitTest
{
  ...
  public void TestInventoryAdd()
  {
    ...
    // Create item types.
    ItemType itemType = new("type1", ItemGroup.CURRENCY, null, 0, 0, false, null, null, null, null);
    ItemType itemType2 = new("type2", ItemGroup.CURRENCY, null, 0, 0, false, null, null, null, null);
    // Create some items.
  ...
  public void TestInventoryRemoveTypes()
  {
    ...
    Inventory inventory = new();
    // Create item types.
    ItemType itemType = new("type1", ItemGroup.CURRENCY, null, 100, 0, false, null, null, null, null);
    // Create some items.
    Item item = new(itemType);
  ...
  public void TestInventoryParentTypes()
  {
    ...
    ItemType grandparent1 = new("grandparent1", ItemGroup.CURRENCY, null, 100, 0, false, null, null, null, null);
    ItemType grandparent2 = new("grandparent2", ItemGroup.CURRENCY, null, 100, 0, false, null, null, null, null);
    ItemType parent1 = new("parent1", ItemGroup.CURRENCY, new List<ItemType> {grandparent1, grandparent2}, 100, 0, false, null, null, null, null);
    ItemType parent2 = new("parent2", ItemGroup.CURRENCY, null, 100, 0, false, null, null, null, null);
    ItemType child1 = new("child1", ItemGroup.CURRENCY, new List<ItemType> {parent1, parent2}, 100, 0, false, null, null, null, null);
    ItemType child2 = new("child2", ItemGroup.CURRENCY, new List<ItemType> {parent1, parent2}, 100, 0, false, null, null, null, null);
    // Create some items.
